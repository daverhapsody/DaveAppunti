...
4.003.000 (quattro milioni, non 4, cose) avrà quattro cifre, che sono 4, 0, 0, 3,
per cui in notazione scientifica avremmo 4,003 x $10^{6}$.
\chapter{Cinematica}
...
\\
\textbf{Illustrazione a cura di Letizia} \\ \\
...
{\color{black} \rule{\linewidth}{0.3mm}}
\\
\textbf{Grafico dell'accelerazione costante} \\ \\
...
{\color{black} \rule{\linewidth}{0.3mm} }
\\
\textbf{Letizia ci salva un'altra volta con un grafico} \\ \\
...
{\color{black} \rule{\linewidth}{0.3mm} }
\\
\textbf{Illustrazione a cura di Simona} \\ \\
...
Quel K si chiama ENERGIA CINETICA, ossia l'energia associata al moto. Mi raccomando,
contate sempre che ci sono altre energie in questione che agiscono su un corpo
in movimento, allora tutto prende senso.
{\color{black} \rule{\linewidth}{0.3mm} }
\\
