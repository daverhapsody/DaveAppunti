...
la CPU deve eseguire per modificare lo stato di un sistema \medskip\\
...
\begin{itemize}
	\item Si basa sul concetto di funzione matematica, ossia una associazione tra due 
...
Controlla un elemento se appartiene ad una lista \medskip\\
(defun member (item list)) \\
(cond ((null list)nil) \\
((equal item(first list))T) \\
(T(member item(rest list)))) \\
(member 42(list 12 34 42)) \medskip\\
DEVO AGGIUNGERE I COLORI AIUTO CE LA POSSO FARE \medskip\\
%%AGGIUNGI I COLORI
