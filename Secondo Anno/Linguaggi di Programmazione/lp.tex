...
\end{itemize}
\paragraph{Just a remainder: }La regola \textbf{R} è variabile:
\begin{itemize}
...
{\color{black} \rule{\linewidth}{0.3mm} }
\\
\textbf{Illustrazione presa dalle slide} \\ \\
...
{\color{black} \rule{\linewidth}{0.3mm} }
\\
\textbf{Stesso esercizio MA con tecnica Right-Most fatto da 
...
prima son state la regola di inferenze e la regola di Prolog) Perciò alla domanda
"quante accezioni del concetto di regola sono state menzionate", si risponderà: 3
...
\begin{enumerate}
	...
	{\color{black} \rule{\linewidth}{0.3mm} }
	\\
	\textbf{Immagine tratta dalle slides} \\ \\
...
{\color{black} \rule{\linewidth}{0.3mm} }
\\
\textbf{Immagine tratta dalle slide} \\ \\
...
In \href{https://swish.swi-prolog.org/}{Swi-Prolog} esiste un predicato che si chiama \textbf{call}, che fa 
questo 
\\ \\
Grazie a queste meta-variabili, possiamo definire il predicato \textbf{Applcia}
