...
per gradi
\begin{enumerate}
	\item null list? false
	\item è 2 = al primo elemento della lista? False
	\item è 2 = al secondo elemento della lista? True
\end{enumerate}
Se LISP trova T è come se scrivessimo  \color{magenta}\textbf{true}\color{black}
